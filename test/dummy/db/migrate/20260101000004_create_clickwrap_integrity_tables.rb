...
# CONCRETE rendering of lib/generators/clickwrap/templates/create_clickwrap_integrity_tables.rb.erb.
#
...
# row.
class CreateClickwrapIntegrityTables < ActiveRecord::Migration[7.1]
  def change
