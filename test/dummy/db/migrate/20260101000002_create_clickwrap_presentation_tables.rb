...
# CONCRETE rendering of lib/generators/clickwrap/templates/create_clickwrap_presentation_tables.rb.erb.
#
...
class CreateClickwrapPresentationTables < ActiveRecord::Migration[7.1]
  def change
